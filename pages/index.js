...
const el = useRef(null);
  ...
  return(
    ...
    <img className={styles.memoji} src='woman.png' /> 
      <img className={styles.circleimg} src='circle.png' />
       <p className={styles.params}>Looking for a way to get your NFT art some audience?<br />Then you've come to the right place<br />here at <b className={styles.bold}>Pump NFT</b>&nbsp;  Buy and increase your NFT audience</p>  
       <div className={styles.button}>
       <button className={styles.button56} role="button"><a href='/Home'>Get started🚀</a></button>
       <img className={styles.dirline} src='dirline.png' />
       </div>
       <div className={styles.man}>
       <img className={styles.manimage} src='name.png'></img>
       <img className={styles.wallet_chart} src='chart.png' />
       </div>
